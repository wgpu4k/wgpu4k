...
abstract class Camera3D  {
    ...
    fun getProjMatrix(width: Float, height: Float): MMatrix4 {
    ...
    protected abstract fun updateMatrix(mat: MMatrix4, width: Float, height: Float)
    ...
    class Perspective(
        ...
        override fun updateMatrix(mat: MMatrix4, width: Float, height: Float) {
