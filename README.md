...
- On iOS (experimental) `./gradlew examples:iOS:assembleWgpuAppXCFramework` to build the XC Framework, then you can run the subproject `iosApp` XCode on a iOS simulator or real device.
