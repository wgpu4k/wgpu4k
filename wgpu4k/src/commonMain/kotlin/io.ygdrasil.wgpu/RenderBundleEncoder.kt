...
expect class RenderBundleEncoder : AutoCloseable {
    ...
    fun drawIndexed(indexCount: GPUSize32, instanceCount: GPUSize32 = 1, firstIndex: GPUSize32 = 0, baseVertex: GPUSignedOffset32 = 0, firstInstance: GPUSize32 = 0)

    fun draw(vertexCount: GPUSize32, instanceCount: GPUSize32 = 1, firstVertex: GPUSize32 = 0, firstInstance: GPUSize32 = 0)
