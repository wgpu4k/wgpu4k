...
open class WGPUDeviceExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
...
open class WGPUNativeLimits : Structure {
	/**
	 * mapped from uint32_t
	 */
	@JvmField
	var maxPushConstantSize: Int = 0

	/**
	 * mapped from uint32_t
	 */
	@JvmField
	var maxNonSamplerBindings: Int = 0
...
open class WGPURequiredLimitsExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
	 ...
	 */
	@JvmField
	var limits: WGPUNativeLimits = WGPUNativeLimits()
...
@Structure.FieldOrder("chain", "limits")
open class WGPUSupportedLimitsExtras : Structure {
	/**
	 * mapped from WGPUChainedStructOut
	 */
	@JvmField
	var chain: WGPUChainedStructOut = WGPUChainedStructOut()
...
open class WGPUPushConstantRange : Structure {
	/**
	 * mapped from WGPUShaderStageFlags
	 */
	@JvmField
	var stages: WGPUShaderStageFlags = 0
...
open class WGPUPipelineLayoutExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
	 ...
	 */
	@JvmField
	var pushConstantRangeCount: NativeLong = NativeLong(0)
	 ...
	 */
	@JvmField
	var pushConstantRanges: Pointer? = null
...
open class WGPUWrappedSubmissionIndex : Structure {
	/**
	 * mapped from WGPUQueue
	 */
	@JvmField
	var queue: WGPUQueue = WGPUQueueImpl()

	/**
	 * mapped from WGPUSubmissionIndex
	 */
	@JvmField
	var submissionIndex: WGPUSubmissionIndex = NativeLong(0)
...
open class WGPUShaderDefine : Structure {
	/**
	 * mapped from (Char(layout = b1))*
	 */
	@JvmField
...
open class WGPUShaderModuleGLSLDescriptor : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
...
open class WGPURegistryReport : Structure {
	/**
	 * mapped from size_t
	 */
	@JvmField
	var numAllocated: NativeLong = NativeLong(0)

	/**
	 * mapped from size_t
	 */
	@JvmField
	var numKeptFromUser: NativeLong = NativeLong(0)

	/**
	 * mapped from size_t
	 */
	@JvmField
	var numReleasedFromUser: NativeLong = NativeLong(0)

	/**
	 * mapped from size_t
	 */
	@JvmField
	var numError: NativeLong = NativeLong(0)

	/**
	 * mapped from size_t
	 */
	@JvmField
	var elementSize: NativeLong = NativeLong(0)
...
open class WGPUHubReport : Structure {
	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var adapters: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var devices: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var queues: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var pipelineLayouts: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var shaderModules: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var bindGroupLayouts: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var bindGroups: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var commandBuffers: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var renderBundles: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var renderPipelines: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var computePipelines: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var querySets: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var buffers: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var textures: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var textureViews: WGPURegistryReport = WGPURegistryReport()

	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var samplers: WGPURegistryReport = WGPURegistryReport()
...
open class WGPUGlobalReport : Structure {
	/**
	 * mapped from WGPURegistryReport
	 */
	@JvmField
	var surfaces: WGPURegistryReport = WGPURegistryReport()
	 ...
	 */
	@JvmField
	var vulkan: WGPUHubReport = WGPUHubReport()

	/**
	 * mapped from WGPUHubReport
	 */
	@JvmField
	var metal: WGPUHubReport = WGPUHubReport()

	/**
	 * mapped from WGPUHubReport
	 */
	@JvmField
	var dx12: WGPUHubReport = WGPUHubReport()

	/**
	 * mapped from WGPUHubReport
	 */
	@JvmField
	var gl: WGPUHubReport = WGPUHubReport()
...
open class WGPUInstanceEnumerateAdapterOptions : Structure {
	/**
	 * mapped from (typedef Optional[const WGPUChainedStruct] =
	 * Declared([a8(next):[*:b1]i4(sType)x4](WGPUChainedStruct)))*
	 */
...
open class WGPUBindGroupEntryExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
	 ...
	 */
	@JvmField
	var buffers: Pointer? = null

	/**
	 * mapped from size_t
	 */
	@JvmField
	var bufferCount: NativeLong = NativeLong(0)

	/**
	 * mapped from (typedef Optional[const WGPUSampler] = (Declared())*)*
	 */
	@JvmField
	var samplers: Pointer? = null

	/**
	 * mapped from size_t
	 */
	@JvmField
	var samplerCount: NativeLong = NativeLong(0)

	/**
	 * mapped from (typedef Optional[const WGPUTextureView] = (Declared())*)*
	 */
	@JvmField
	var textureViews: Pointer? = null

	/**
	 * mapped from size_t
	 */
	@JvmField
	var textureViewCount: NativeLong = NativeLong(0)
...
open class WGPUBindGroupLayoutEntryExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
...
open class WGPUQuerySetDescriptorExtras : Structure {
	/**
	 * mapped from WGPUChainedStruct
	 */
	@JvmField
	 ...
	 */
	@JvmField
	var pipelineStatistics: Pointer? = null

	/**
	 * mapped from size_t
	 */
	@JvmField
	var pipelineStatisticCount: NativeLong = NativeLong(0)
