...
interface NSDraggingSource {
	 ...
	 */
	fun draggingSourceOperationMaskForLocal(flag: Boolean): NSUInteger?
	 ...
	 */
	fun draggedImage_beganAt(image: NSImage?, point: NSPoint?)
	 ...
	 */
	fun draggedImage_endedAt_operation(image: NSImage?, point: NSPoint?, operation: NSUInteger?)
	 ...
	 */
	fun draggedImage_movedTo(image: NSImage?, point: NSPoint?)

	/**
	 * Original signature : `BOOL ignoreModifierKeysWhileDragging()`<br></br>
	 * *native declaration : line 79*
	 */
	fun ignoreModifierKeysWhileDragging(): Boolean

	fun namesOfPromisedFilesDroppedAtDestination(dropDestination: NSURL?): NSArray?
}
