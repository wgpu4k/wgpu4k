...
@CName("io.ygdrasil.wgpu.internal.JniInterface.wgpuCreateInstance")
...
fun JNIEnv.callIntMethodFrom(thiz: jobject, methodName: String): Int {
...
fun JNIEnv.getObjectClass(thiz: jobject) = pointed.pointed!!.GetObjectClass!!.invoke(this, thiz)
fun JNIEnv.getMethodID(jclass: jclass, methodName: String, signature: String) = memScoped {
    pointed.pointed!!.GetMethodID!!.invoke(this@getMethodID, jclass, methodName.cstr.ptr, signature.cstr.ptr)
}
fun JNIEnv.callObjectMethodA(thiz: jobject, methodId: jmethodID) = pointed.pointed!!.CallIntMethodA!!.invoke(this, thiz, methodId, null)